...
**기술 스택**:
- **Frontend**: HTML/CSS/JavaScript (현재) 또는 React 전환
- **Backend**: Node.js + Express.js
- **Database**: PostgreSQL (관계형) 또는 MongoDB (NoSQL)
- **인증**: JWT (JSON Web Token)
- **배포**:
  - Frontend: GitHub Pages 또는 Vercel
  - Backend: Railway, Render, 또는 Heroku
  - Database: Railway, Supabase, 또는 MongoDB Atlas

---

### Option 2: Firebase (빠른 개발)
...
### Option 3: Supabase (Firebase 오픈소스 대안)
...
| 항목 | 서비스 | 무료 티어 | 유료 시 |
|------|--------|-----------|---------|
| Frontend | Vercel | ✅ 무료 | $0 |
| Backend | Railway | 500시간/월 무료 | $5/월~ |
| Database | Railway PostgreSQL | 무료 (제한적) | $5/월~ |
| **총계** | | **무료** | **$10/월~** |
...
| 항목 | 무료 티어 | 유료 시 |
|------|-----------|---------|
| Authentication | 무제한 | $0 |
| Firestore | 1GB 저장 | 초과 시 종량제 |
| Hosting | 10GB/월 | 초과 시 종량제 |
| **총계** | **무료** | **$5~20/월** |
...
**다음**: Phase 3 완료 후 본 문서를 기반으로 Phase 4 시작
