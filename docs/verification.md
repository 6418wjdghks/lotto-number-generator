...
> 마지막 검증: 2026-02-15 (`840529b`) — **전 Tier ALL PASS, CLAUDE.md 검증 수준 정의 추가 후 정밀 검증**
...
|----------|----------|------|----------|------|---------|
| A1 | 13 | 54.7K | 77.4s | 0 | 0건 |
| A2 | 10 | 32.7K | 50.8s | 0 | 0건 |
| A3 | 5 | 26.1K | 26.7s | 0 | 0건 |
| B | 3 | 31.6K | 27.4s | 0 | 0건 |
| D | 6 | 39.3K | 18.8s | 0 | 0건 |
